  ...
  var arrayTeste = [
      ...
      "conteudos": [
        {
          "tipo": "texto",
          "conteudo":
              "A matéria é tudo aquilo que possui massa e ocupa lugar no espaço. Ela é formada por partículas extremamente pequenas chamadas átomos.",
        },
    ...
    },
    {
      ...
      "conteudos": [
        ...
        {"tipo": "video", "conteudo": "assets/videos/videoExample.mp4"},
      ],
    },
  ];
        ...
        if (page["pagina"] == paginaAtual) {
          ...
          (page["conteudos"] as List).forEach((content) {
            ...
            if (content["tipo"] == "imagem") {
              conteudo.add(
                Image.asset(content["conteudo"] as String, width: 600),
              );
            }

            if (content["tipo"] == "texto") {
              conteudo.add(Text(content["conteudo"] as String));
            }

            if (content["tipo"] == "video") {
              _videoController = VideoPlayerController.networkUrl(
                Uri.parse(content["conteudo"]),
              );
              ...
              conteudo.add(
                GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                    maxCrossAxisExtent: 550, // largura máxima do card
                    crossAxisSpacing: 10,
                    mainAxisSpacing: 10,
                    childAspectRatio: content["tipo2"] == "texto" ? 3 : 2.5,
                  ),
    ...
    setState(() {
      ...
      setas = Row(
        ...
        children: [
          ...
          IconButton(
            onPressed: paginaAtual == paginaTotal
                ? concluirAula
                : avancarPagina,
            disabledColor: Colors.grey,
            icon: Icon(Icons.arrow_forward, size: 30),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SingleChildScrollView(
                          child: Column(spacing: 20, children: [...conteudo]),
                        ),
